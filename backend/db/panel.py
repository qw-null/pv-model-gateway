...
class PVPanel(Base):
    ...
    temp_coeff   = Column(Float, default=0.0, comment="温度系数 mA/℃")

    # ── 单二极管模型计算结果 ───────────────────────────────────
    g_ref        = Column(Float, default=1000.0, comment="运行条件GRef W/m²")
    t_ref        = Column(Float, default=25.0,   comment="运行条件TRef ℃")
    ...
    mu_voc_spec  = Column(Float, default=-92.5,  comment="Voc温度系数 mV/℃")
